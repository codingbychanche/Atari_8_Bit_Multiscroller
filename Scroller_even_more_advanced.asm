; Faster horizontal scrolling and complexer DLI
;
; Loop routines for left and right scrolling repleaced by non- loop
; solution.
...
hardUp
	...
	sta $d405
	sta vclocks
		; Get starting adress of first row of pf from antic programm
s111				
	lda z0+1
	clc
	adc #<pfwidth
...
dli1								
	...
	lda #20		; Color for bit combination: 11
	sta colpf2s
	sta wsync
	
	lda #28		; Color for bit combination: 01	
	sta colpf0s									
	sta wsync
